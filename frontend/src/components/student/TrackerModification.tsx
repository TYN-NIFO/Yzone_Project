...
import { Edit3, Save, X, Clock, FileText, MessageSquare, Star, Plus } from 'lucide-react';
      ...
      <>
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
          ...
          <p className="text-yellow-700 mb-4">
            You haven't submitted a tracker entry for today yet.
          </p>
          <button
            onClick={() => setShowSubmitForm(true)}
            className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2 mx-auto"
          >
        ...
        {showSubmitForm && (
          <TrackerForm
            ...
            onSuccess={() => { setShowSubmitForm(false); fetchTodayTracker(); }}
          />
        )}
      </>
    );
